...
final class Class62 {
   ...
   int[] anIntArray945;
   static Class94 aClass94_946 = Class3_Sub4.buildString(")2");
   int anInt947;
   private static Class94 aClass94_948 = Class3_Sub4.buildString("You can(Wt add yourself to your own friend list)3");
   Class69 aClass69_949;
   static int anInt950;
   static Class94 aClass94_951 = Class3_Sub4.buildString("Interfaces charg-Bes");
   static int anInt952;
   int[] anIntArray953;
   int[] anIntArray954;
   int[] anIntArray955;
