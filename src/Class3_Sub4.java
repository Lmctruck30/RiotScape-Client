...
final class Class3_Sub4 extends Class3 {
	...
	static Class94 aClass94_2252 = buildString("Atteindre");
	int anInt2253;
	int anInt2254;
	static Class94 aClass94_2255 = buildString("Suche nach Updates )2 ");
	int anInt2256;
	int anInt2257;
	static Class153 aClass153_2258;
	int anInt2259 = -1;
	static Class94 aClass94_2260 = buildString("Lade Wordpack )2 ");
	int anInt2261 = 0;
	int anInt2262;
	int anInt2263;
	int anInt2264;
	...
	static final Class94 buildString(String var0) {
		try {
			...
			throw Class44.method1067(var8, "cd.D(" + (var0 != null?"{...}":"null") + ')');
		}
	}
