...
final class Class3_Sub17 extends Class3 {
   ...
   static Class94 aClass94_2458 = Class3_Sub4.buildString("Module texte charg-B");
   static int anInt2459;
   int[][] anIntArrayArray2460;
   static Class94 aClass94_2461 = Class3_Sub4.buildString("3D)2Softwarebibliothek gestartet)3");
   int anInt2462;
   boolean[] aBooleanArray2463;
   
   private static Class94 aClass94_2465 = Class3_Sub4.buildString("");
   int[] anIntArray2466;
