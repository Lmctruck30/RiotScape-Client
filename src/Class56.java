...
final class Class56 {
   ...
   static Class94 aClass94_888 = Class3_Sub4.buildString("<col=ffff00>");
   static int anInt889;
   static Class106[] aClass106Array890;
   
   static Class94 aClass94_892 = Class3_Sub4.buildString(" )2> <col=ffffff>");
   static int anInt893 = 0;
   private static Class94 aClass94_894 = Class3_Sub4.buildString("Walk here");
