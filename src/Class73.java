...
final class Class73 implements Runnable {
   ...
   static Class94 aClass94_1085 = Class3_Sub4.buildString("brillant1:");
   private Class13 aClass13_1086 = new Class13();
   int anInt1087 = 0;
   static int anInt1088 = 0;
   static Class94 aClass94_1089 = Class3_Sub4.buildString("Chargement des sprites )2 ");
   ...
   static final void method1308(Class94 var0, boolean var1) {
      try {
         if(2 <= Class3_Sub13_Sub26.anInt3320) {
            ...
            if(var0.method1558(GameApplet.aClass94_10, 0)) {
