...
final class Class3_Sub13_Sub23_Sub1 extends Class3_Sub13_Sub23 {
   ...
   private static Class94 aClass94_4030 = Class3_Sub4.buildString("Allocating memory");
   ...
   static Class94 aClass94_4036 = Class3_Sub4.buildString("Connect-B au serveur de mise -9 jour");
   ...
   static final void loadGameError(String argurment, byte var1) {
      try {
         if(var1 != 38) {
            anIntArray4035 = (int[])null;
         }

         System.out.println("Bad " + argurment + ", Usage: worldid, <live/rc/wip>, <english/german>, <game0/game1>");
         System.exit(1);
      } catch (RuntimeException var3) {
         throw Class44.method1067(var3, "kd.O(" + (argurment != null?"{...}":"null") + ',' + var1 + ')');
      }
   }
