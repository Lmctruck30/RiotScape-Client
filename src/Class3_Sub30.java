...
class Class3_Sub30 extends Class3 {
	...
	private static Class94 aClass94_2593 = Class3_Sub4.buildString("Loaded interfaces");
	static Class94 aClass94_2594 = Class3_Sub4.buildString("Polices charg-Bes");
	int anInt2595;
	static Class94[] aClass94Array2596 = null;
	static Class94 aClass94_2597 = aClass94_2593;
	static Class94 aClass94_2598 = Class3_Sub4.buildString("<br>");
	static Class94 aClass94_2599 = Class3_Sub4.buildString("d-Broulement:");
	...
	final int method788(int var1) {
		try {
			...
			if(var1 != -1741292848) {
				this.rsaKeyParse((BigInteger)null, (BigInteger)null, 11);
			}
	...
	final void rsaKeyParse(BigInteger var1, BigInteger var2, int var3) {
		try {
