...
final class Class3_Sub28_Sub4 extends Class3_Sub28 {
   ...
   static Class94 aClass94_3573 = Class3_Sub4.buildString(" )2> <col=00ffff>");
   static Class94 aClass94_3574 = Class3_Sub4.buildString("titlebg");
  
   static Class94 aClass94_3576 = Class3_Sub4.buildString("name_icons");
   static Class94 aClass94_3577 = Class3_Sub4.buildString(": ");
   private static Class94 aClass94_3578 = Class3_Sub4.buildString("Loaded title screen");
         ...
         if(var1 != -1) {
            ...
            if(null == this.aClass94Array3571) {
               ...
               for(int var3 = 1; var3 < this.aClass94Array3571.length; ++var3) {
                  var2.method1533(GameApplet.aClass94_9, true);
