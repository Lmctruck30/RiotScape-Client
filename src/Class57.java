...
final class Class57 {
   ...
   int anInt896 = 0;
   static Class94 aClass94_897 = Class3_Sub4.buildString("Liste des mises -9 jour charg-Be");
   static int[] anIntArray898 = new int[2500];
   int anInt899 = 2048;
   static int anInt900;
   static Class94 aClass94_901 = Class3_Sub4.buildString("Ihre Ignorieren)2Liste ist voll)1 Sie k-Onnen nur 100 Spieler darauf eintragen)3");
   static int anInt902 = 100;
   static int anInt903;
   static int[] anIntArray904 = new int[200];
   static Class94 aClass94_905 = Class3_Sub4.buildString("Sprites charg-Bs");
   static int anInt906;
   int anInt907 = 0;
   int anInt908 = 2048;
