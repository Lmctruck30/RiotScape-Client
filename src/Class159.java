...
final class Class159 {
   ...
   static Class94 aClass94_2018 = Class3_Sub4.buildString("Cabbage");
   ...
   static final boolean method2194(int var0) {
      try {
         if(Class3_Sub28_Sub11.aBoolean3641) {
            try {
               return !((Boolean)Class3_Sub13_Sub17.aClass94_3209.method1577(var0 + -2112, Class38.aClass87_665.gameApplet)).booleanValue();
