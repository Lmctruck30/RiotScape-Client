...
class Class163 {
   ...
   static Class94 aClass94_2042 = Class3_Sub4.buildString("Spieler kann nicht gefunden werden: ");
   static int[] anIntArray2043 = new int[]{8, 11, 4, 6, 9, 7, 10, 0};
   static Class94 aClass94_2044 = Class3_Sub4.buildString("cookieprefix");
   static Class94 aClass94_2045 = Class3_Sub4.buildString("::errortest");
