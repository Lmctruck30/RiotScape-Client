...
final class Class140_Sub3 extends Class140 {
   ...
   static Class94 aClass94_2723 = Class3_Sub4.buildString("<col=c0ff00>");
   ...
   private static Class94 aClass94_2731 = Class3_Sub4.buildString("wave:");
   private int anInt2732;
   private int anInt2733;
   private int anInt2734;
   static Class94 aClass94_2735 = Class3_Sub4.buildString(")4");
   private int anInt2736;
   static int anInt2737 = 0;
   private Class109_Sub1 aClass109_Sub1_2738 = null;
   private static Class94 aClass94_2739 = Class3_Sub4.buildString("Drop");
   ...
   private final Class140 method1962(boolean var1, int var2) {
      try {
         ...
         if(null == var4) {
            ...
            int var6;
            if(Class158.clientGameType != 0 && this.aBoolean2721 && (null == this.aClass142_2722 || null != this.aClass142_2722 && ~this.aClass142_2722.anInt1864 != ~var4.anInt1531)) {
               var6 = var4.anInt1531;
               if(0 == ~var4.anInt1531) {
                  var6 = var5;
               }
