...
final class Class33 {
   ...
   private static String validCharacters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:\'@#~,<.>/?\\| " + String.valueOf('\u00c4') + '\u00cb' + '\u00cf' + '\u00d6' + '\u00dc' + '\u00e4' + '\u00eb' + '\u00ef' + '\u00f6' + '\u00fc' + '\u00ff' + '\u00df' + '\u00c1' + '\u00c0' + '\u00c9' + '\u00c8' + '\u00cd' + '\u00cc' + '\u00d3' + '\u00d2' + '\u00da' + '\u00d9' + '\u00e1' + '\u00e0' + '\u00e9' + '\u00e8' + '\u00ed' + '\u00ec' + '\u00f3' + '\u00f2' + '\u00fa' + '\u00f9' + '\u00c2' + '\u00ca' + '\u00ce' + '\u00d4' + '\u00db' + '\u00e2' + '\u00ea' + '\u00ee' + '\u00f4' + '\u00fb' + '\u00c6' + '\u00e6';
   private static int validCharactersLength = validCharacters.length();
   ...
   Class33(int var1, boolean var2, Component var3) {
      this.anInt596 = validCharactersLength * 9;
      this.aBoolean595 = false;
      Font var4 = new Font("Helvetica", var2?1:0, var1);
      FontMetrics var5 = var3.getFontMetrics(var4);

      int var6;
      for(var6 = 0; var6 < validCharactersLength; ++var6) {
         this.method1004(var4, var5, validCharacters.charAt(var6), var6, false);
      }
      ...
      if(var2 && this.aBoolean595) {
         ...
         if(!this.aBoolean595) {
            ...
            for(var6 = 0; var6 < validCharactersLength; ++var6) {
               this.method1004(var4, var5, validCharacters.charAt(var6), var6, true);
            }
         }
      }
   ...
   static {
      for(int var0 = 0; var0 < 256; ++var0) {
         int var1 = validCharacters.indexOf(var0);
         if(var1 == -1) {
            var1 = 74;
         }
