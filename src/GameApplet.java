...
public abstract class GameApplet extends Applet implements Runnable, FocusListener, WindowListener {
   ...
   boolean aBoolean554 = false;
   static int anInt2;
   static int anInt3 = 0;

   private static Class94 aClass94_5 = Class3_Sub4.buildString(" from your ignore list first)3");
   static boolean aBoolean6 = false;
   static Class94 aClass94_7 = Class3_Sub4.buildString(" s(West d-Bconnect-B)3");
   static Class94 aClass94_8 = Class3_Sub4.buildString("");
   static Class94 aClass94_9 = Class3_Sub4.buildString(")3)3)3");
   static Class94 aClass94_10 = Class3_Sub4.buildString("::rect_debug");
   ...
   public final AppletContext getAppletContext() {
      try {
         return null != Class3_Sub13_Sub7.aFrame3092?null:(Class38.aClass87_665 != null && this != Class38.aClass87_665.gameApplet?Class38.aClass87_665.gameApplet.getAppletContext():super.getAppletContext());
      } catch (RuntimeException var2) {
   ...
   final synchronized void method30(byte var1) {
      try {
         ...
         if(Class3_Sub13_Sub10.aFrame3121 != null) {
            ...
            var2 = Class38.aClass87_665.gameApplet;
         }
   ...
   public final void destroy() {
      try {
         if(this == Class3_Sub29.anApplet_Sub1_2588 && !aBoolean554) {
   ...
   final void gameError(String var1, int var2) {
      try {
         if(!this.aBoolean1) {
            this.aBoolean1 = true;
   ...
   public final URL getDocumentBase() {
      try {
         return null != Class3_Sub13_Sub7.aFrame3092?null:(Class38.aClass87_665 != null && this != Class38.aClass87_665.gameApplet?Class38.aClass87_665.gameApplet.getDocumentBase():super.getDocumentBase());
      } catch (RuntimeException var2) {
   ...
   private final void method35(int var1, boolean var2) {
      try {
         ...
         if(Class38.aClass87_665.gameApplet != null) {
            Class38.aClass87_665.gameApplet.destroy();
         }
   ...
   public final URL getCodeBase() {
      return Class3_Sub13_Sub7.aFrame3092 == null?(null != Class38.aClass87_665 && this != Class38.aClass87_665.gameApplet?Class38.aClass87_665.gameApplet.getCodeBase():super.getCodeBase()):null;
   }

   public final void run() {
      try {
         try {
            if(null != Class87.javaVendorName) {
               String var1 = Class87.javaVendorName.toLowerCase();
            ...
            if(null != Class38.aClass87_665.gameApplet) {
               Method var8 = Class87.aMethod1220;
               if(null != var8) {
                  try {
                     var8.invoke(Class38.aClass87_665.gameApplet, new Object[]{Boolean.TRUE});
   ...
   public final String getParameter(String var1) {
      try {
         return Class3_Sub13_Sub7.aFrame3092 == null?(Class38.aClass87_665 != null && this != Class38.aClass87_665.gameApplet?Class38.aClass87_665.gameApplet.getParameter(var1):super.getParameter(var1)):null;
      } catch (RuntimeException var3) {
   ...
   public final void stop() {
      try {
         if(Class3_Sub29.anApplet_Sub1_2588 == this && !aBoolean554) {
   ...
   final void method40(int var1, int var2, boolean var3, int var4, String var5, int var6, int var7, int var8) {
      try {
         ...
         try {
            ...
            Class3_Sub13_Sub7.aFrame3092.setTitle("RiotScape");
         ...
         try {
            if(Class3_Sub29.anApplet_Sub1_2588 != null) {
               ...
               if(~Class36.anInt639 <= -4) {
                  this.gameError("alreadyloaded", -48);
                  return;
               }
