...
final class Class94 implements Interface3 {
   ...
   static Class94 aClass94_2149 = Class3_Sub4.buildString("Bitte warten Sie )2 es wird versucht)1 die Verbindung wiederherzustellen)3");
   static boolean aBoolean2150;
   private boolean aBoolean2152 = true;
   byte[] aByteArray2153;
   static boolean aBoolean2154;
   static Class94 allyreqString = Class3_Sub4.buildString(":allyreq:");
   int anInt2156;
   static int[] anIntArray2157 = new int[50];
   static Class94 allocatedMemoryString = Class3_Sub4.buildString("Allocated memory");
   ...
   public static void method1541(int var0) {
      try {
         ...
         if(var0 != -8635) {
            allocatedMemoryString = (Class94)null;
         }
