...
final class Class119 {
   ...
   static Class94 aClass94_1625 = Class3_Sub4.buildString("Memory before cleanup=");
   static Class33 aClass33_1626;
   static Class26[] aClass26Array1627;
   static Class153 aClass153_1628;
   static int anInt1629;
   static Class94 aClass94_1630 = Class3_Sub4.buildString("Mem:");
      ...
      try {
         ...
         if(null == Class3_Sub13_Sub10.aFrame3121) {
            if(Class3_Sub13_Sub7.aFrame3092 != null) {
               ...
               var1 = Class38.aClass87_665.gameApplet;
            }
         } else {
